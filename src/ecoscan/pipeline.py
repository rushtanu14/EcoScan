...
SPECIES_LIBRARY = [
    {
        ...
        "aliases": ["monarch", "butterfly", "milkweed", "insect"],
        "factors": ["vegetation_stress", "dry_air_stress", "air_pollution_stress"],
        "threat_level": "High",
        "population_trend": "Declining 80% since 1980s",
        "narrative": "Western monarch migration routes depend on continuous milkweed corridors. Climate warming and habitat fragmentation are compressing breeding windows and reducing nectar availability.",
        "action_items": [
            "Plant native milkweed species (Asclepias californica) in sunny grassland patches",
            "Restore spring and late-season wildflower blooms for nectar diversity",
            "Create wildlife corridors connecting fragmented milkweed habitats",
    ...
    },
    {
        ...
        "aliases": ["frog", "amphibian", "wetland", "redlegged"],
        "factors": ["moisture_stress", "water_quality_stress", "thermal_stress"],
        "threat_level": "High",
        "population_trend": "Critically endangered, <1% of historical range",
        "narrative": "This federally threatened species requires clean, cool water with minimal disturbance. Invasive predators (bullfrogs, crayfish), water diversion, and thermal stress from climate change have reduced populations to isolated wetland refuges. Breeding ponds are becoming too warm (>20°C kills tadpoles).",
        "action_items": [
            "Remove invasive bullfrogs and signal crayfish from breeding pools",
            "Restore water quality monitoring and flow to maintain 14-18°C pools",
            "Create deep-water refugia with dense native aquatic vegetation",
            "Protect upland migration corridors for metamorphosing frogs",
            "Establish captive breeding and reintroduction programs",
        ],
    },
    {
        ...
        "threat_level": "Medium",
        "population_trend": "Stable but concentrated in remaining oak stands",
        "narrative": "Acorn woodpeckers are cavity-nesting specialists that depend on multi-generational oak trees. They create 'granaries'—thousands of precisely-sized acorn holes—to sustain family groups through winter. Oak canopy loss and increased temperatures are reducing acorn production and cavity availability.",
        "action_items": [
            "Protect mature oak stands from removal and prevent canopy thinning",
            "Manage water stress in residual oak forests through soil remediation",
            "Monitor acorn production and supplement with native oak plantings",
            "Retain cavity trees (snags) and prevent dead-wood removal",
        ],
    },
    {
        ...
        "action_items": [
            "Implement multi-year irrigation for oak seedling establishment in riparian zones",
            "Remove competing invasive grasses and provide shade protection for saplings",
            "Protect groundwater tables through reduced agricultural extraction",
            "Create oak savanna restoration sites with native grassland understory",
            "Establish seed orchards and nursery programs for acorn collection",
        ],
    },
    {
        ...
        "population_trend": "Declining where invasive species present",
        "narrative": "This long-lived (60+ years) turtle requires stable water chemistry, open basking areas, and soft banks for egg-laying. Reduced pool permanence from water diversion, invasive bullfrogs that prey on hatchlings, and thermal stress threaten survival. Water temperatures >28°C stress egg development.",
        "action_items": [
            "Maintain year-round water availability in shallow refuge pools",
            "Remove invasive bullfrogs through targeted removal programs",
            "Create soft-bank nesting habitat using native bank vegetation",
            "Restore riparian shade to maintain cool microhabitats",
            "Monitor water chemistry and reduce agricultural runoff",
        ],
    },
    {
        ...
        "population_trend": "Stable but habitat-dependent",
        "narrative": "Black phoebes are sentinel species for riparian corridor health. They hunt flying insects from exposed perches along water, requiring both open structure and dense vegetation for nesting. Insect decline from agricultural runoff and streamside simplification reduces food availability.",
        "action_items": [
            "Restore native shrub cover near streams for nesting habitat",
            "Reduce pesticide input to support insect populations",
            "Maintain open perching areas near water for foraging",
            "Protect streamside vegetation from grazing pressure",
        ],
    },
    {
        ...
        "threat_level": "Medium",
        "population_trend": "Declining with grassland conversion",
        "narrative": "California milkweed is the exclusive host plant for monarch caterpillars west of the Sierra. It thrives in sunny native grassland edges, but becomes stunted in dry conditions. Herbicide drift, mowing, and habitat conversion have eliminated 95% of historical grassland milkweed stands.",
        "action_items": [
            "Seed native milkweed in restored grassland patches",
            "Protect from herbicide drift with riparian buffer zones",
            "Avoid mowing or grazing during spring and early summer growth",
            "Supplement water during establishment phase (first 2-3 years)",
            "Monitor monarch egg-laying success on restored plants",
        ],
    },
    {
        ...
        "threat_level": "Low-Medium",
        "population_trend": "Stable but reduced vigor in heat stress zones",
        "narrative": "Coyote brush is a drought-adapted native shrub that buffers habitat edges from extreme wind and heat. It provides cover for birds and insects, and stabilizes soil after disturbance. Overgrazing and urban heat island effects are reducing shrub vigor and density.",
        "action_items": [
            "Restore coyote brush in habitat edge zones to reduce heat penetration",
            "Protect from overgrazing by fencing riparian exclosures",
            "Improve soil water retention through mulching and organic matter",
            "Use as restoration pioneer species in disturbed grassland areas",
        ],
    },
]
