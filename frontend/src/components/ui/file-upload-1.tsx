...
export default function FileUpload05({ selectedFile, onSelect, onClear, onSubmit }: FileUploadProps) {
  return (
    <div className="sm:mx-auto sm:max-w-lg flex items-center justify-center p-6 md:p-10 w-full max-w-lg">
      <form
        className="w-full"
        onSubmit={(event) => {
          ...
          <div className="relative mt-8 rounded-lg bg-muted p-3">
            ...
            <div className="flex items-center space-x-2.5">
              <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-sm bg-background shadow-sm ring-1 ring-inset ring-input">
                <FileSpreadsheet className="size-5 text-foreground" aria-hidden={true} />
              </span>
