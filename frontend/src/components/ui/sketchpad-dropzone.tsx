  ...
  return (
    <div>
      ...
      <div
        ...
        onDrop={handleDrop}
        className="relative border-2 border-dashed border-gray-400/60 rounded-lg p-8 min-h-[260px] bg-teal-100 flex flex-wrap gap-4 items-start cursor-pointer text-zinc-900"
        style={{
          backgroundImage:
