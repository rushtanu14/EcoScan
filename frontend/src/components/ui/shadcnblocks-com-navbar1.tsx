...
const renderMenuItem = (item: MenuItem) => {
  ...
  return (
    <a
      key={item.title}
      className="group inline-flex h-10 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium text-teal-700 transition-colors hover:bg-teal-100 hover:text-accent-foreground"
      href={item.url}
    >
      {item.title}
    </a>
