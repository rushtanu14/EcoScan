...
const fallbackData: Gallery4Item[] = [
  {
    id: "one",
    title: "Wetland hotspot",
    description: "A location where moisture stress and thermal pressure overlap.",
    href: "#",
    image:
  ...
  },
  {
    id: "two",
    title: "Habitat edge",
    description: "A transition zone where species pressure rises quickly.",
    href: "#",
    image:
  ...
  },
  {
    ...
    description: "A restoration band designed to improve species refuge quality.",
    href: "#",
    image:
...
const Gallery4 = ({
  title = "Species case cards",
  description = "Each slide pairs visual evidence with habitat context and next actions.",
  items = fallbackData,
}: Gallery4Props) => {
